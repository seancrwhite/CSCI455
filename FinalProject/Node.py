...
class Enemy(Node):
    ...
    def execute(self, player):
        if self.is_visited == False:
            ...
            if self.health < 0 and self.has_key == True:
                self.is_visited = True
                player.has_key = True
                return "I found an enemy...... Fighting...... I won the fight! And found a key! "
            elif self.health < 0:
                self.is_visited = True
                return "I found an enemy...... Fighting...... I won the fight! "
            else:
                return "I found an enemy...... Fighting...... I lost the fight, my health was depleated. Game over. "
        else:
...
class Recharge(Node):
    def execute(self, player):
        player.health = 20
        return "Recharge station. My health has been restored."
